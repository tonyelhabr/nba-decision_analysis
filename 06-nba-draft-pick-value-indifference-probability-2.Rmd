---
title: Indifferent Probability and NBA Draft Pick Value, Cont.
author: Tony
date: "2016-07-04"
categories:
  - nba
tags:
  ...
  - Wages of Wins
  - win shares
banner: "images/nba-draft-pick-value-indifferent-probability-2/coin-flip-clipart.png"
---

In this post I will continue where I left off in [my prior discussion][1] of the
concept of [__indifferent probability__][2] (IP) and its application to the NBA
...
I discussed in [my original write-up][3] on the big-picture value of NBA draft
...
which I brought up in [another one of my posts][4]. I found that, when
...
relative trade value of picks?"__) that I asked [before][5]. Furthermore, with
...
<img src="images/nba-draft-pick-value-indifferent-probability/figure-5-average-theoretical-four-year-first-round-wsv-and-cost-ips.jpg" />
<p id="fig_label">
Figure 1: Average Theoretical Four-Year __First-Round__ WSV and Cost IPs
</p>

<img src="images/nba-draft-pick-value-indifferent-probability/figure-6-average-theoretical-four-year-first-round-wsv-to-cost-ip-differentials.jpg" />
<p id="fig_label">
Figure 2: Average Theoretical Four-Year __First-Round__ WSV to Cost IP
Differentials
</p>
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/figure-3-average-theoretical-four-year-first-and-second-round-wsv-and-cost-ips.jpg" />
<p id="fig_label">
Figure 3: Average Theoretical Four-Year __First- and Second-Round__ WSV and
Cost IPs
</p>

<img src="images/nba-draft-pick-value-indifferent-probability-2/figure-4-average-theoretical-four-year-first-and-second-round-wsv-to-cost-ip-differentials.jpg" />
<p id="fig_label">
Figure 4: Average Theoretical Four-Year __First- and Second-Round__ WSV to
Cost IP Differentials
  </p>
...
previous post</a>. Figure 8 in his research, which I reproduce below, captures the same idea that I present here in my Figure 3
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/aaron-barzilai-draft-pick-estimated-player-value-and-salary-graph.jpg" />
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/figure-5-first-round-draft-pick-trade-value.jpg" />
<p id="fig_label">
Figure 5: __First-Round__ Draft Pick Trade Value
</p>
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/figure-6-first-and-second-round-draft-pick-trade-value.jpg" />
<p id="fig_label">
Figure 6: __First- and Second-Round__ Draft Pick Trade Value
</p>
...
^[As I indicated in a <a
href="https://numbernonsense.updog.co/estimate-value-nba-draft-pick/">
prior post</a>, the 30th value is somewhat skewed by the fact that drafts
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/figure-7-top-10-draft-pick-trade-value.jpg" />
<p id="fig_label">
...
<img src="images/nba-draft-pick-value-indifferent-probability-2/arturo-galletti-relative-draft-pick-trade-value-top-10-only.jpg" />
<p id="fig_label">
...
previous post</a>, Galletti simply calculates the quotient of the values
...
results on this topic in a <a href="https://numbernonsense.updog.co/nba-draft-pick-value-research-2/">previous post</a>.)
...
increase beyond 10. However, as I discussed in that previous post, it is 
...
<img 
src="images/nba-draft-pick-value-indifferent-probability-2/figure-arturo-galleti-top-10-draft-pick-trade-value-avg-wins-ip.jpg" /> <p 
id="fig_label"> Figure 10: Arturo Galletti's Top 10 Draft Pick Trade 
Value (__Neglecting__ Cost) </p> 
...
average empirical four-year <a 
href="http://wagesofwins.com/wins-produced/"> __wins produced__</a> (WP) 
and <a href="http://www.basketball-reference.com/about/ws.html"> __win 
shares__</a> (WS) respectively for our on-court value measurements, 
...
[1]: https://numbernonsense.updog.co/indiffirent-probability-nba-draft-pick-value/
[2]: https://en.wikipedia.org/wiki/Principle_of_indifferent
[3]: https://numbernonsense.updog.co/estimate-value-nba-draft-pick/
[4]: https://numbernonsense.updog.co/nba-draft-pick-value-research/
[5]: https://numbernonsense.updog.co/questions-answers-nba-draft-pick-value/
