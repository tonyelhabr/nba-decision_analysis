---
title: Indifferent Probability and the NBA Draft
author: Tony
date: "2016-07-01"
categories:
  - nba
tags:
  ...
  - utility theory
  - win shares
banner: "images/nba-draft-pick-value-indifferent-probability/indifferent-probability-clipart.png"
---

The value of NBA draft picks relative to can be calculated using 
the concept of __[indifferent probability][1]__ (IP), a term I 
briefly referenced in [a previous post][2] highlighting the value 
of information in the context of the NBA draft. I believe that 
IPs can be used to extend my analysis in [another post][3] 
...
picks). In other words, I can find an answer to the second question (__“At 
which draft slots does the expected basketball production outperform the 
contractual obligation the most?”__) that I posed in [my review of existing 
research][4]
on the topic of NBA draft pick value, as well as answer to the 
first question (__"What is the relative trade value of 
picks?"__) that I asked in its [follow-up article][5].
...
For those of you who are not as familiar with __[utility 
theory][6]__ or __[decision analysis][7]__, IPs are simply 
...
sets shown in figures in [my post][3]
on general NBA draft pick value.

<img 
src="images/nba-draft-pick-value-estimate/figure-7-average-regressed-empi
rical-four-year-profit-of-1995-2012-first-round-draft-picks.jpg" />

<p id="fig_label">Figure 1: Average Regressed 
Empirical Four-Year Profit of 1995 --- 2012 First-Round Draft Picks 
</p>

<img 
src="images/nba-draft-pick-value-estimate/figure-10-average-re
gressed-theoretical-four-year-profit-of-1995-2012-first-round-draft-
picks.jpg" />

<p id="fig_label">Figure 2: Average Regressed 
Empirical Four-Year Profit of 1995 --- 2012 First-Round Draft Picks 
</p>
...
<img 
src="/img/nba-draft-indifferent-probability/figure-3-average-four-year-first-round-wsv-ips.jpg" />
<p id="fig_label">
Figure 3: Average Four-Year First-Round WSV IPs
</p>
...
can formally prove the notion of __[diminishing return][8]__ that 
was implied by the profit curves that we saw before.

We can calculate __[return on investment][9]__ (ROI), which is 
...
<img 
src="/img/nba-draft-indifferent-probability/figure-4-average-theoretical-four-year-wsv-to-cost-ratios-roi.jpg" />

<p id="fig_label">
Figure 4: Average Theoretical Four-Year WSV to Cost Ratios (ROI)
</p>
...
<img 
src="/img/nba-draft-indifferent-probability/figure-5-average-theoretical-four-year-first-round-wsv-and-cost-ips.jpg/" />

<p id="fig_label">Figure 5: Average __Theoretical__ 
Four-Year First-Round WSV and Cost __IPs__ </p>

<img 
src="/img/nba-draft-indifferent-probability/figure-6-average-theoretical-four-year-first-round-wsv-to-cost-ip-differentials.jpg" />

<p id="fig_label">Figure 6: Average __Theoretical__ 
Four-Year First-Round WSV to Cost __IP Differentials__ </p>

<img 
src="/img/nba-draft-indifferent-probability/figure-7-average-empirical-four-year-first-round-wsv-to-cost-ip-differentials.jpg" />

<p style="text-align: center;"> Figure 7: 
Average __Emperical__ Four-Year First-Round  WSV to Cost __IP 
Differentials__ </p>
...
obligation the most?”__) in [a previous post][4].
...
[1]: https://en.wikipedia.org/wiki/Principle_of_indifference
[2]: https://numbernonsense.updog.co/value-perfect-information-nba-draft/
...
[6]: http://www.businessdictionary.com/definition/utility-theory.html
[7]: http://www.prioritysystem.com/glossary1a.html#decisionanalysis
[8]: https://en.wikipedia.org/wiki/Diminishing_returns
[9]: http://www.investopedia.com/terms/r/returnoninvestment.asp
[10]: http://www.businessdictionary.com/definition/market-inefficiency.html
