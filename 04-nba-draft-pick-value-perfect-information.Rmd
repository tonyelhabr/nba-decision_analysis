...
[__value of perfect information__](https://en.wikipedia.org/wiki/Expected_value_of_perfect_information)
...
[__decision analysis__](http://www.prioritysystem.com/glossary1a.html#decisionanalysis) (DA) are 
[__certain equivalent__](http://www.prioritysystem.com/glossary1aa.html#ce) (CE) and the 
[__delta principle__](http://www.prioritysystem.com/glossary1aa.html#d).] 
...
[__indifference probability__](https://en.wikipedia.org/wiki/Principle_of_indifference)
...
__extensive-form__(https://en.wikipedia.org/wiki/Extensive-form_game)
game with uncertainty at each move. Put another way, it can be modeled as 
__decision tree__(http://www.stylusandslate.com/decision_trees/4_0.../4_0_glossary.html) with a
__decision node__(http://www.stylusandslate.com/decision_trees/4_0.../4_0_glossary.html) 
for each draft slot (and its corresponding team) and an accompanying 
__chance node__(href="http://www.stylusandslate.com/decision_trees/4_0.../4_0_glossary.html) 
...
__expectimax__(href="https://en.wikipedia.org/wiki/Expectiminimax_tree) 
...
would be eliminated, and a __minimax(https://en.wikipedia.org/wiki/Minimax)__ strategy 
